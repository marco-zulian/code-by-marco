...
let Card = class Card extends LitElement {
    ...
    render() {
      ...
      <div class="${this.getBackgroundColor()} relative overflow-hidden pt-9.5 md:pt-11.25 rounded-md">
        ...
        <div class="flex flex-col gap-2 md:gap-4 bg-navy-900 hover:bg-navy-800 rounded-t-md p-8 md:p-6 z-10 relative">
          ...
          <div class="flex justify-between items-center md:flex-col md:items-start md:gap-2">
            <p class="font-rubik text-white font-light text-xl/[38px] md:text-2xl/[66px] md:align-top">${this.currAmount}hr${this.currAmount > 1 ? 's' : ''}</p>
